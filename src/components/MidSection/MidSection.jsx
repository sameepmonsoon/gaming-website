  ...
  return (
    <div className="h-screen w-full bg-background/90 flex  flex-col justify-center items-center pb-2">
      <div className="flex w-full h-[95%] items-center justify-around">
        <span className="bg-background w-[600px] h-[405px] rounded-[4px] flex flex-col items-start justify-start p-10">
      ...
      <div className="w-3/6 min-h-[20%] bg-transparent text-white rounded-[10px] border-[1px] border-gray/40 flex justify-between items-center px-10">
        <span className="tournament w-[300px] h-[150px] rounded-md flex flex-col justify-between items-start p-2 bg-background">
        ...
        <span className="tournament w-[150px] h-[150px] rounded-md flex flex-col justify-between items-start p-2 bg-background">
        ...
        <span className="tournament w-[200px] h-[150px] rounded-md flex flex-col justify-center items-center p-2 bg-background gap-y-2">
          ...
          <p className="h-5 bg-black/50  border-[1px] border-gray w-20 flex justify-center rounded-[4px]">Jolt</p>
        </span>
      </div>
    </div>
  );
