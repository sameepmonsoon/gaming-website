...
import { HiBars3 } from "react-icons/all";
const Navbar = (props) => {
  const { links } = props;
  ...
  return (
    <>
      ...
      <div
        ...
        <div className="order-3 group relative h-[3rem] min-w-[11rem] p-2 bg-gray/10 flex items-center justify-center cursor-pointer">
          login / register{" "}
          <span className="h-[4px] bg-red w-full absolute left-0 bottom-0">
            &nbsp;
          </span>
